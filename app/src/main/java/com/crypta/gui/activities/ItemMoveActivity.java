...
public class ItemMoveActivity extends DropboxActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (activityClass != null && activityClass.equals("com.crypta.gui.activities.FilesActivity")) {
    ...
    protected void moveItem() {
        ...
        if (file_path != null && file_name != null) {
            ...
            new MoveFileTask(ItemMoveActivity.this, DropboxClientFactory.getClient(), new MoveFileTask.Callback() {
                @Override
